...
void youngest(string name1, string name2, string name3, int age1, int age2, int age3){
    ...
    if(age1 < age2 && age1 < age3){
        cout << "\n" << name1 << ", you are the youngest among the other 2 people.";
    } else if (age2 < age1 && age2 < age3){
        cout << "\n" << name2 << ", you are the youngest among the other 2 people.";
    } else if (age3 < age1 && age3 < age2){
        cout << "\n" << name3 << ", you are the youngest among the other 2 people.";
    } else if(age1 == age2 && age1 < age3){
        cout << "\n" << name1 << " and " << name2 << " are the youngest.";
    } else if(age1 == age3 && age1 < age2){
        cout << "\n" << name1 << " and " << name3 << " are the youngest.";
    } else if(age2 == age3 && age2 < age1){
        cout << "\n" << name2 << " and " << name3 << " are the youngest.";
    } else {
...
void oldest(string name1, string name2, string name3, int age1, int age2, int age3){
    ...
    if(age1 > age2 && age1 > age3){
        cout << "\n" << name1 << ", you are the oldest among the other 2 people.";
    } else if (age2 > age1 && age2 > age3){
        cout << "\n" <<name2 << ", you are the oldest among the other 2 people.";
    } else if (age3 > age1 && age3 > age2){
        cout << "\n" <<name3 << ", you are the oldest among the other 2 people.";
    } else if(age1 == age2 && age1 > age3){
        cout << "\n" <<name1 << " and " << name2 << " are the oldest.";
    } else if(age1 == age3 && age1 > age2){
        cout << "\n" <<name1 << " and " << name3 << " are the oldest.";
    } else if(age2 == age3 && age2 > age1){
        cout << "\n" <<name2 << " and " << name3 << " are the oldest.";
    } else {
        cout << "\nAll three people are the same age.";
    }
